<template>
  ...
  >
    ...
    <!-- 表格页 -->
    <Page1 v-else-if="$page.frontmatter.tablePage" />
    <!-- 文章页或其他页 -->
    <Page
      v-else
...
import Page1 from '@theme/components/Page1.vue'
...
export default {
  components: { Home, Navbar, Page, Page1, CategoriesPage, TagsPage, ArchivesPage, Sidebar, Footer, Buttons, BodyBgImg },
